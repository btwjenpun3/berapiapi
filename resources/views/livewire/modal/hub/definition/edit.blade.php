                            ...
                            <div class="card mt-3">
                                <div class="card-body bottom-border-tab">
                                    <ul class="nav nav-tabs border-tab mb-0" id="bottom-tab" role="tablist">
                                        <li class="nav-item">
                                            <button class="nav-link nav-border txt-info tab-info pt-0"
                                                id="path-edit-tab" data-bs-toggle="tab" href="#path-edit" role="tab"
                                                aria-controls="path-edit" aria-selected="true" wire:ignore.self>
                                                Path Parameter
                                            </button>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content" id="bottom-tabContent">
                                        <div class="tab-pane fade" id="path-edit" role="tabpanel"
                                            aria-labelledby="path-edit-tab" wire:ignore.self>
                                    ...
                                    <div class="tab-content" id="bottom-tabContent">
                                        <div class="tab-pane fade" id="headers-edit" role="tabpanel"
                                    ...
                                    <div class="tab-content" id="bottom-tabContent">
                                        <div class="tab-pane fade show active" id="query-edit" role="tabpanel"
